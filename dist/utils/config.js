...
exports.LOG_FILE = `${__dirname}/../log/log.csv`;
exports.BAD_LOG_FILE = `${__dirname}/../log/badLog.csv`;
exports.INSERTED_MONGO_ID = `${__dirname}/../log/allMongoID.csv`;
exports.INSERTED_PG_ID = `${__dirname}/../log/insertedPgID.csv`;
exports.AUTH_INFO = {
    user: 'systemalert@smartretail.co',
    pass: 'iaMsMartReTail'
};
exports.RECEIVERS = ['henry@smartretail.co', 'jimmy@smartretail.co', 'ivan@smartretial.co', 'calvin@smartretail.co'];
exports.MONGO_DB = 'Lipios';
const MONGO_USER = "lipios-admin";
const MONGO_PWD = "BTF43nc8O*BY(RlprfY";
const MONGO_HOST4 = "primary";
const MONGO_HOST1 = "10.255.254.150:27017";
const MONGO_HOST2 = "10.255.254.150:27017";
const MONGO_HOST3 = "10.255.254.106:27017";
const pgHost = "10.255.254.150";
exports.MONGO_URLs = `mongodb://${MONGO_USER}:${MONGO_PWD}@${MONGO_HOST1}/${exports.MONGO_DB}`;
exports.PG_CONNECT_CONFIG = {
    host: "10.255.254.150",
    database: 'mongo2psql',
    user: 'mongotransfer',
    password: '12345678',
...
exports.OTHER_TABLES = ['stores', 'storetags', 'vendors', 'products', 'producttags', 'users'];
exports.REFILL_RECORD = 'refillrecords';
const default_schema = '"_id" varchar (255) NOT NULL PRIMARY KEY,"mongo_doc" jsonb,"mongo_doc_update_time" TimestampTz,"record_update_time" TimestampTz';
const transactions = '"_id" varchar (80) NOT NULL UNIQUE,"vendor" varchar (80),"retailerName" varchar (80),"error" varchar (255),"orderID" varchar (80),"orderType" varchar (80),"paymentAmount" NUMERIC(15, 2),"paymentMethodName" varchar (80),"paymentStatus" varchar (80),"storeCode" varchar (80),"transactionTime" TimestampTz,"uploadedTime" TimestampTz,"others" jsonb,"code" varchar (80),"__v" smallInt,"specialPromotion" jsonb[], "items" jsonb[]';
const vendor_schema = '"_id" varchar(80) NOT NULL,"name" varchar(80),"description" varchar(80),"updated_at" TimestampTz,"created_at" TimestampTz,"__v" smallInt,"created_by" varchar(80),"features" jsonb[],"payments" jsonb[], "image" text';
const product_schema = '"_id" varchar(80) NOT NULL,"vendor" varchar(80),"photo" text,"updated_at" TimestampTz,"created_at" TimestampTz,"code" text,"__v" smallInt,"barcode" text,"descriptions" jsonb,"nutritions" jsonb,"brand_names" jsonb,"names" jsonb,"video" text,"optional_data" jsonb,"isVirtualProduct" bool,"additional" text';
const product_tag_schema = ' "_id" varchar(80) NOT NULL,"vendor" varchar(80),"name" varchar(80),"updated_at" TimestampTz,"created_at" TimestampTz,"products" text[],"__v" smallInt';
const store_schema = '"_id" varchar(80) NOT NULL,"code" varchar(80),"vendor" varchar(80),"name" varchar(80),"model" varchar(80),"country" varchar(80),"city" varchar(80),"district" varchar(80),"address" varchar(480),"last_online_at" TimestampTz,"updated_at" TimestampTz,"created_at" TimestampTz,"stocks" jsonb[],"advertisment" jsonb[],"paymentMethods" text[],"__v" smallInt,"payments" jsonb[],"groups_enabled" bool,"zakkaya_ver" varchar(80),"last_get" TimestampTz,"last_refill" TimestampTz,"last_sync" TimestampTz,"last_reset" TimestampTz,"unsubmitted_order_count" int4,"advertisements" jsonb[],"groups" jsonb[]';
const store_tag_schema = '"_id" varchar(80) NOT NULL,"vendor" varchar(80),"name" varchar(80),"updated_at" TimestampTz,"created_at" TimestampTz,"stores" text[],"__v" smallInt';
const refill_schema = '"_id" varchar(80) NOT NULL,"storeCode" varchar(80),"event" varchar(80),"refiller" varchar(80),"refillId" smallInt,"aisleNo" smallInt,"productCode" varchar(80),"capacity" smallInt,"previousInventory" smallInt,"refilledInventory" smallInt,"adjustedInventory" smallInt,"status" varchar (80),"updatedAt" TimestampTz,"syncTime" TimestampTz,"__v" smallInt';
const user_schema = '"_id" varchar(80) NOT NULL,"username" text,"password" text,"vendor" text,"supplier" text,"email" text,"name" text,"img" text,"admin_type" text,"edit_external" boolean,"read_only" boolean,"system_message_enable" boolean,"special_promotion_enable" boolean,"screen_saver_enable" boolean,"__v" int,"updated_at" TimestampTz,"created_at" TimestampTz';
exports.TABLE_MAPPING = {
...
exports.OBJECT_VALUE = (obj) => Object.keys(obj).map(key => obj[key]);
exports.MUSTACHE_HTML = `
<html>
  <head>
    <style type="text/css">
